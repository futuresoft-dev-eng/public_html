...
<div class="buttons-container">
    <button class="navigation-btn active" id="userAccountsBtn" onclick="activateButton('userAccountsBtn', 'add_user.php')">User Account</button>
...
<div class="table-container">
    ...
    <select id="statusFilter" style="margin-bottom: 15px; padding: 5px; border-radius: 5px; border: 1px solid #02476A; color: #02476A;">
        ...
        <?php
    $rolesQuery = "SELECT DISTINCT account_status FROM users";
    $rolesResult = $conn->query($rolesQuery);

    if ($rolesResult->num_rows > 0) {
        while ($role = $rolesResult->fetch_assoc()) {
            echo "<option value='" . htmlspecialchars($role['account_status']) . "'>" . htmlspecialchars($role['account_status']) . "</option>";
        }
    }
    ?>
    </select>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr data-role='" . htmlspecialchars($row['role']) . "'>
                            ...
                            <td>
                    <a href='edit_user.php?user_id=" . htmlspecialchars($row['user_id']) . "' id='view-btn-" . htmlspecialchars($row['user_id']) . "'>
...
$(document).ready(function () {
    ...
    if (!$('.import-btn').length) {
        ...
        <!-- Create New Resident -->
            <a href="create_user.php" class="create-btn">
    ...
    if (selectedStatus === "") {
        ...
        // Otherwise, filter by the selected account status
