...
.slideshow {
    width: 1200px !important; /* Adjusted width */
...
#map {
    ...
    margin: 1850px 0px 0px -0px !important;
    position: absolute;
}

.map-image {
    width: 60%;
    margin: 1520px 0px 100px 130px !important;
