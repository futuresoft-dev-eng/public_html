...
<form id="editForm" method="POST">
    ...
    style="position: absolute; margin: 3px 0px 0px -490px;"> 
    <span style="margin-left: 30px;">Male</span>
    </label>

    <label>
    <input type="radio" name="sex" value="Female" <?= $user['sex'] === 'Female' ? 'checked' : '' ?> disabled 
    style="position: absolute; margin: -37px 0px 0px -410px;"> 
    <span style="margin: -40px 0px 0px 110px; position: absolute;">Female</span>
</label>
</div>
