...
?>
    ...
    <div class="top-bar d-md-none">
        ...
        <a href="la_profile.php" class="nav-link">
    ...
    <nav class="sidebar d-none d-md-flex flex-column p-0">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item">
                    <a href="flood_alerts.php" class="active-link">
                        <span class="material-symbols-rounded">notifications_active</span> <span class="icon-text">Flood Alerts</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="smsalerts.php" class="nav-link" style="margin-top: 60px;">
                        <span class="material-symbols-rounded">sms</span> <span class="icon-text">SMS Alerts</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="floodhistory.php" class="nav-link" style="margin-top: 0px;">
                        <span class="material-symbols-rounded">history</span> <span class="icon-text">Flood Alert Logs</span>
                    </a>
                </li>
            </ul>
        </div>

        <h2 style="margin-top: 650px; position: absolute;">Logged in as:</h2>
